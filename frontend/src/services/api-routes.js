...
export const apiRoutes = Object.freeze({
  ...
  jobs: Object.freeze({
    ...
    readiness: (id) => `${API_V1}/jobs/${encodeURIComponent(id)}/application-readiness`,
    tailoringPlan: (id) => `${API_V1}/jobs/${encodeURIComponent(id)}/tailoring-plan`,
    resumeVersions: (id) => `${API_V1}/jobs/${encodeURIComponent(id)}/resume-versions`,
    coverLetters: (id) => `${API_V1}/jobs/${encodeURIComponent(id)}/cover-letters`,
  ...
  copilot: Object.freeze({
    resumeVersion: (id) => `${API_V1}/resume-versions/${encodeURIComponent(id)}`,
    resumeExport: (id) => `${API_V1}/resume-versions/${encodeURIComponent(id)}/export`,
    coverLetter: (id) => `${API_V1}/cover-letters/${encodeURIComponent(id)}`,
    workspace: `${API_V1}/application-workspace`,
    workspaceJob: (id) => `${API_V1}/application-workspace/${encodeURIComponent(id)}`,
    analytics: `${API_V1}/application-workspace/analytics`,
  }),
