...
/** Fails deployment before a unique Adzuna index is attempted against legacy duplicates. */
@Component
...
public class MongoIndexInitializer implements ApplicationRunner {
    ...
    @Override public void run(ApplicationArguments args) {
        ...
        if (!duplicates.isEmpty()) throw new IllegalStateException("Cannot create jobs source_external_id_unique index: duplicate source/externalId records exist. Run backend/scripts/audit-mongo-indexes.js first.");
